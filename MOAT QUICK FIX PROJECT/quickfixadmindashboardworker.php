  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a style="font-size:25px;color: rgb(255, 255, 255)" class="nav-link active" aria-current="page" href="
http://localhost/kilophp/week3bootstrap/quickfixadmindashboard.php">Home</a>
        </li>
...
?>
   ...
   <div class="row">
<div class="col-md-6">
 <h1 style="color:whitesmoke" > Add another worker</h1>
...
<input type="text" name="firstname" placeholder="Enter firstname" class="form-control" value="" required >


<br>
<br>
 <label>Lastname</label>
<input type="text" name="lastname" placeholder="Enter last name " class="form-control" value=""  required>
...
<br>
<br>
<button class="btn  btn-danger" name="submit"  value="submit" id="regbutt">Add a worker</button>
...
?>
<h1 align="center"> Workers Table</h1>
...
<td>
  ...
  <a href="editworker.php?id=<?php echo $id; ?>" class="btn btn-primary-sm">
